        ...
        global: {
            ...
            onActionEvent: (actionEvent) => {
                ...
                if(/\?/.test(currentUrl)) {
                    ...
                    // 2024-06-25-이수정 업데이트
                    if(/mylab/.test(utm_campaign) && /detergent/.test(utm_content)) {  // 01_mylab · detergent

                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.paramValue1 = "mylab";
                        actionEvent.user.attributes.paramValue2 = "detergent";
                        // console.log("======== paramValue1, utm_campaign : mylab 보냄"); 
                        // console.log("======== paramValue2, utm_content : detergent 보냄");  
                        
                    } 
                    else if(/mylab/.test(utm_campaign) && /fiber/.test(utm_content)) {  // 02_mylab · fiber

                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.paramValue1 = "mylab";
                        actionEvent.user.attributes.paramValue2 = "fiber";
                        // console.log("======== paramValue1, utm_campaign : mylab 보냄"); 
                        // console.log("======== paramValue2, utm_content : fiber 보냄"); 
                        
                    } 
                    else if(/mylab/.test(utm_campaign) && /sanitary/.test(utm_content)) {  // 03_mylab · sanitary

                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.paramValue1 = "mylab";
                        actionEvent.user.attributes.paramValue2 = "sanitary";
                        // console.log("======== paramValue1, utm_campaign : mylab 보냄"); 
                        // console.log("======== paramValue2, utm_content : sanitary 보냄"); 
                        
                    } 
                    else if(/mylab/.test(utm_campaign) && /mosquito/.test(utm_content)) {  // 04_mylab · mosquito

                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.paramValue1 = "mylab";
                        actionEvent.user.attributes.paramValue2 = "mosquito";
                        // console.log("======== paramValue1, utm_campaign : mylab 보냄"); 
                        // console.log("======== paramValue2, utm_content : mosquito 보냄"); 
                        
                    } 
                    else if(/air/.test(utm_campaign) && /basic/.test(utm_content)) {  // 05_air · basic

                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.paramValue1 = "air";
                        actionEvent.user.attributes.paramValue2 = "basic";
                        // console.log("======== paramValue1, utm_campaign : air 보냄"); 
                        // console.log("======== paramValue2, utm_content : basic 보냄"); 
                        
                    } 
                    else if(/bodycare/.test(utm_campaign) && /basic/.test(utm_content)) {  // 06_bodycare · basic

                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.paramValue1 = "bodycare";
                        actionEvent.user.attributes.paramValue2 = "basic";
                        // console.log("======== paramValue1, utm_campaign : bodycare 보냄"); 
                        // console.log("======== paramValue2, utm_content : basic 보냄"); 
                        
                    } 
                    else if(/vcs/.test(utm_campaign) && /airsterilizer/.test(utm_content)) {  // 07_vcs · airsterilizer

                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.paramValue1 = "vcs";
                        actionEvent.user.attributes.paramValue2 = "airsterilizer3";
                        // console.log("======== paramValue1, utm_campaign : vcs 보냄"); 
                        // console.log("======== paramValue2, utm_content : airsterilizer 보냄"); 
                        
                    } 

                    else if(/vcs/.test(utm_campaign) && /virus/.test(utm_content)) {  // 08_vcs · virus

                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.paramValue1 = "vcs";
                        actionEvent.user.attributes.paramValue2 = "virus";
                        // console.log("======== paramValue1, utm_campaign : vcs 보냄"); 
                        // console.log("======== paramValue2, utm_content : virus 보냄"); 
                        
                    } 
                    else if(/water/.test(utm_campaign) && /basic/.test(utm_content)) {  // 09_water · basic

                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.paramValue1 = "water";
                        actionEvent.user.attributes.paramValue2 = "basic";
                        // console.log("======== paramValue1, utm_campaign : water 보냄"); 
                        // console.log("======== paramValue2, utm_content : basic 보냄"); 
                        
                    } 
                    else if(/ipm/.test(utm_campaign) && /family/.test(utm_content)) {  // 10_ipm · family

                        actionEvent.user = actionEvent.user || {};
                        actionEvent.user.attributes = actionEvent.user.attributes || {};
                        actionEvent.user.attributes.paramValue1 = "ipm";
                        actionEvent.user.attributes.paramValue2 = "family";
                        // console.log("======== paramValue1, utm_campaign : ipm 보냄"); 
                        // console.log("======== paramValue2, utm_content : family 보냄"); 
                        
                    } 
                    else if(/ipm/.test(utm_campaign) && /basic/.test(utm_content)) {  // 11_ipm · basic
...
//------------------------------------------ 장소별 추천 pageType ------------------------------------------//
            ...
            // 장소별 추천(가정집) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_HOME
            {
                name: "PRD_HP_PC_PLACE_HOME",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/home/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Home Page"
                },
            },

            // 장소별 추천(외식업장) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_RESTAURANT
            {
                name: "PRD_HP_PC_PLACE_RESTAURANT",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/restaurant/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Restaurant Page"
                },
            },

            // 장소별 추천(유통시설) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_RETAIL
            {
                name: "PRD_HP_PC_PLACE_RETAIL",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/retail/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Retail Page"
                },
            },

            // 장소별 추천(교육시설) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_EDU
            {
                name: "PRD_HP_PC_PLACE_EDU",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/edu/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Edu Page"
                },
            },

            // 장소별 추천(빌딩시설) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_BUILDING
            {
                name: "PRD_HP_PC_PLACE_BUILDING",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/building/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Building Page"
                },
            },

            // 장소별 추천(서비스시설) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_SERVICE
            {
                name: "PRD_HP_PC_PLACE_SERVICE",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/service/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Service Page"
                },
            },

            // 장소별 추천(문화시설) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_CULTURE
            {
                name: "PRD_HP_PC_PLACE_CULTURE",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/culture/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Culture Page"
                },
            },

            // 장소별 추천(의료시설) pageTypes 선언/
            // ▼ PRD_HP_PC_PLACE_MEDICAL
            {
                name: "PRD_HP_PC_PLACE_MEDICAL",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/medical/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Medical Page"
                },
            },

            // 장소별 추천(특급호텔/리조트) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_HOTEL
            {
                name: "PRD_HP_PC_PLACE_HOTEL",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/hotel/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Hotel Page"
                },
            },

            // 장소별 추천(모텔/일반호텔) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_MOTEL
            {
                name: "PRD_HP_PC_PLACE_MOTEL",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/motel/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Motel Page"
                },
            },

            // 장소별 추천(식품제조) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_FOODFACTORY
            {
                name: "PRD_HP_PC_PLACE_FOODFACTORY",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/foodfactory/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Foodfactory Page"
                },
            },

            // 장소별 추천(제조공장) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_FACTORY
            {
                name: "PRD_HP_PC_PLACE_FACTORY",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/factory/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Factory Page"
                },
            },

            // 장소별 추천(창고시설) pageTypes 선언
            // ▼ PRD_HP_PC_PLACE_STORAGE
            {
                name: "PRD_HP_PC_PLACE_STORAGE",
                isMatch: () => /cesco\.co\.kr\/solution\/place\/storage/.test(window.location.href),
                interaction: {
                    name: "PRD_HP_PC - View Place Storage Page"
                },
            },
